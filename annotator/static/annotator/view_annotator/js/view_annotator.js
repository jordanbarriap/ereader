...
(function() {
  ...
  //constants
  var IMAGE_DELETE =  '/static/annotator/img/icono_eliminar.png',
  IMAGE_DELETE_OVER = '/static/annotator/img/papelera_over.png',
  SHARED_ICON = '/static/annotator/img/shared-icon.png';
  ...
  Annotator.Plugin.AnnotatorViewer = (function(_super) {
    ...
    */
    ...
    AnnotatorViewer.prototype.onSavePanel = function(event) {
     ...
     //Event triggered when cancel the saving of the content of the annotation
    ...
    AnnotatorViewer.prototype.mascaraAnnotation = function(annotation) {
      ...
      if (!annotation.datetime) annotation.datetime = $.now();

      var shared_annotation = "";
      var class_label = "label";
      var delete_icon = "<img src=\""+IMAGE_DELETE+"\" class=\"annotator-viewer-delete\" title=\""+ i18n_dict.Delete +"\" style=\" float:right;margin-top:3px;;margin-left:3px\"/><img src=\"/static/annotator/img/edit-icon.png\"   class=\"annotator-viewer-edit\" title=\"Edit\" style=\"float:right;margin-top:3px\"/>";
